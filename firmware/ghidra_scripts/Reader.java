...
public class Reader extends GhidraScript {
  ...
  void info(long fe){
    ...
    println("\n###### 0x"+Long.toHexString(fe)+" "+(f==null?"NOFUNC":f.getName()+" .."+f.getBody().getMaxAddress()));
    if(f==null) return;
  ...
  public void run() throws Exception {
    ...
    info(0x0C0CA118L);  // struct-base getter PTR target
    info(0x0C0C7472L);  // post-edit refresh leaf (code5 tempo)
  }
}
